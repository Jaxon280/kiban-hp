...
interface NewsEditFormProps {
  newsItem: News;
  params: { slug: string }; // params を Props に追加
}

export default function NewsEditForm({ newsItem, params }: NewsEditFormProps) {
  // params を Props から受け取る
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || "ニュースの更新に失敗しました");
      }
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold font-sf-pro">ニュースの編集</h1>
            <Link
              href="/admin"
